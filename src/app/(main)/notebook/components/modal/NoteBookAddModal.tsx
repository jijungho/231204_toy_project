...
export default function NoteBookAddModal({ onClickCloseNoteAddModal }: any) {
  ...
  return (
    <div className="w-full h-full">
      <div className="absolute top-0 w-full max-w-[1720px] h-full bg-gray-500 opacity-30"></div>
      <div className="absolute top-0 left-24 w-full h-full flex justify-center items-center">
