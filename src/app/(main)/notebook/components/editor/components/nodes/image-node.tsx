...
import type { DOMExportOutput, EditorConfig, LexicalNode, NodeKey, SerializedEditor, SerializedLexicalNode, Spread } from "lexical";
...
export function $createImageNode({ altText, height, maxWidth = 1000, src, width, key }: ImagePayload): ImageNode {
