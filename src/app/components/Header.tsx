...
export default function Header() {
  ...
  return (
    <>
      <div className='w-full bg-gray-300 h-[50px]'>
        <div className="w-full mx-auto">
          <ul className="flex w-full h-full">
            ...
            <li className='flex relative'>
              <button className='absolute top-[2px] left-0'>
                <Image
                  src='/img/search.png'
                  alt='search-img'
                  className='h-[24px] '
              ...
              <input type="text" className='pl-[30px]' />
            </li>
          </ul>
          <ul className="">
            <li></li>
      ...
      <div className='w-full'>
        <section className='w-full flex '>
          <aside className='flex w-[12.5%] border-1 border-#ddd'>
            <nav className='flex'>
              <ul className=''>
